...
function SkillItem({ icon, title }: SkillItemProps) {
  return (
    <div className="flex flex-col items-center w-24 justify-center p-2 transition-all transform hover:scale-105 hover:rotate-3 hover:shadow-xl rounded-lg text-center gap-y-2 cursor-pointer">
